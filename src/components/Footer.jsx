...
const footerLinks = {
  Shop: ['Indoor Plants', 'Outdoor Plants', 'Succulents', 'Bonsai', 'Flowering Plants', 'Pots & Décor'],
  Services: ['Balcony Garden', 'Terrace Garden', 'Office Greenery', 'Café Decoration', 'Vertical Gardens'],
  Help: ['Track Order', 'Shipping Policy', 'Return Policy', 'Plant Care FAQs', 'Contact Support'],
  Company: ['About Prakruti', 'Our Story', 'Blog', 'Careers', 'Press'],
};
        ...
        <div className="pt-6 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex gap-4">
            {['Privacy Policy', 'Terms of Service', 'Cookie Policy'].map(link => (
              <a key={link} href="#" className="font-sans text-xs text-white/35 hover:text-white/60 transition-colors">
                {link}
              </a>
            ))}
          </div>
